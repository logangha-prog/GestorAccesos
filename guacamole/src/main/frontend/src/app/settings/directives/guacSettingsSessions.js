...
angular.module('settings').directive('guacSettingsSessions', [function guacSettingsSessions() {
    ...
    return {
        ...
        controller: ['$scope', '$injector', 'userHelperService', function settingsSessionsController($scope, $injector, userHelperService) {
           ...
           var wrapAllActiveConnections = function wrapAllActiveConnections() {
               ...
               if (!allActiveConnections || !allConnections || !sessionDateFormat || !user)
                   return;
		                        ...
		                        if (addedUsers[activeConnection.username]) {
          	                    ...
          	                    if (organization && userObtained 
          		                    ...
          		                    $scope.wrappers.push(new ActiveConnectionWrapper({
          		                        dataSource       : dataSource,
          			                    name             : connection.name,
          			                    startDate        : $filter('date')(activeConnection.startDate,
                                                                          sessionDateFormat),
          			                    activeConnection : activeConnection
          	                        }));
          	                    }
