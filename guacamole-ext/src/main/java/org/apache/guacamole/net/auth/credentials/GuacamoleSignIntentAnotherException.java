 ...
 */
public class GuacamoleSignIntentAnotherException extends GuacamoleCredentialsException {

    /**
     * Creates a new GuacamoleSignIntentAnotherException with the given
     ...
     */
    public GuacamoleSignIntentAnotherException(String message, Throwable cause,
     ...
     *     Information describing the form of valid credentials.
     */
    public GuacamoleSignIntentAnotherException(String message, CredentialsInfo credentialsInfo) {
        super(message, credentialsInfo);
    }

    /**
     * Creates a new GuacamoleSignIntentAnotherException with the given cause
     ...
     *     Information describing the form of valid credentials.
     */
    public GuacamoleSignIntentAnotherException(Throwable cause, CredentialsInfo credentialsInfo) {
